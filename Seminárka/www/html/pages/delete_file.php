...
<body class="bg-yellow-400">
    ...
    <h1 class="text-center text-3xl font-bold bg-yellow-400 my-8">Smazání</h1>
    <div class="max-w-xl bg-black mt-10 pt-4 mx-auto rounded-lg shadow-md">
        <div class="bg-black px-4">
            <h2 class="text-lg font-semibold text-yellow-400">Vyber kryptoměnu pro smazání</h2>
        </div>
        <div class="bg-black p-4">
            <form id="cryptoSelectForm" class="space-y-4 custom-form">
                ...
                <div class="flex justify-end">
                    <button type="button" onclick="deleteFile()" class="inline-flex items-center px-4 py-2 text-sm bg-yellow-400 rounded-md font-semibold text-black uppercase tracking-widest">Smazat</button>
                </div>
            </form>
        </div>
    </div>
